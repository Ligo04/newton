...
class Example:
    def __init__(self, viewer, args):
        ...
        allegro_hand = newton.ModelBuilder(up_axis=newton.Axis.Y)
        ...
        allegro_hand.add_usd(
            asset_file,
            xform=wp.transform(wp.vec3(0, 0.5, 0)),
    ...
    def test_final(self):
        ...
        for i in range(self.world_count):
            ...
            newton.examples.test_body_state(
                ...
                lambda q, qd: float(q[1]) > -0.5 and float(q[1]) < 2.0,
